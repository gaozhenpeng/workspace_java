...
public class Brave4HttpSenderWithSpanInScopeOneTracingMain {
	private static final Logger logger = LoggerFactory.getLogger(Brave4HttpSenderWithSpanInScopeOneTracingMain.class);
