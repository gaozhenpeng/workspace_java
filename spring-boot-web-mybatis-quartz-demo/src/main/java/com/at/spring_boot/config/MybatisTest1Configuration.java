 ...
 */
@Configuration
@MapperScan(basePackages = "com.at.spring_boot.mybatis.mapper1", sqlSessionFactoryRef="sqlSessionFactory1")
...
public class MybatisTest1Configuration {
    ...
    public AspectJExpressionPointcutAdvisor transactionAdvisor() {
        ...
        advisor.setExpression("(execution(* com.at.spring_boot.web.svr1.*Service.*(..)))");
        return advisor;
    }
}
