...
public class AWSListInstanceMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            log.info("You have access to " + availabilityZonesResult.getAvailabilityZones().size()
                    + " Availability Zones.");
            ...
            log.info("You have " + instances_size + " Amazon EC2 instance(s) running.");
