 ...
 */
@Configuration
@MapperScan(basePackages = "com.at.spring_boot.mybatis.mapper2", sqlSessionFactoryRef="sqlSessionFactory2")
...
public class MybatisTest2Configuration {
    ...
    public AspectJExpressionPointcutAdvisor transactionAdvisor() {
        ...
        advisor.setExpression("(execution(* com.at.spring_boot.web.svr2.*Service.*(..)))");
        return advisor;
    }
}
