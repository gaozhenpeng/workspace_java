...
public class HWController {
	...
	@RequestMapping(value = "/helloworld/1", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(value = "/helloworld/2", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(path = "/helloworld/raw")
