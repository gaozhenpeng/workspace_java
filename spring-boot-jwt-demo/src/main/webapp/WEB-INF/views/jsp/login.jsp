...
<body>
	...
	<form action="<c:url value='/jwt/dologin'/>" method="POST" id="loginFrm" onSubmit="return false;">
		<label>User Name</label> <input type="text" name="username" maxLength="40" value="myusername" />
		<label>Password</label> <input type="password" name="password" value="mypassword" />
