...
public class MaxTemperatureSpark {
	/**
	 * run:
	 *   spark-submit --class com.at.spark.MaxTemperatureSpark --master local target\spark-0.0.1-SNAPSHOT.jar formatted_record/19011902-stationid_temperature_quality_year.rec output
	 */
			...
			new PairFunction<String[], Integer, Integer>(){
				...
				public Tuple2<Integer, Integer> call(String[] rec){
					return new Tuple2<Integer, Integer>(
							Integer.parseInt(rec[3], 10), Integer.parseInt(rec[1]));
				}
			}
		);
